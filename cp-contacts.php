             ...
             <div class="contact-flex">
               <div>
                 <div class="contact-item">
                   <div><span class="icon icon-mail"><i class="fas fa-envelope"></i></span></div>
                   <div>
                     <h6>E-mail</h6>
                     <a href="mailto:l2topservers@gmail.com">l2topservers@gmail.com</a>
                   </div>
                 </div>
               </div>
               <div>
                 <div class="contact-item">
                   <div><span class="icon icon-facebook"><i class="fab fa-facebook-square"></i></span></div>
                   <div>
                     <h6>Facebook</h6>
                     <a href="">fb.com/l2topserverscom</a>
                   </div>
                 </div>
               </div>
               <div>
                 <div class="contact-item contact-last-item">
                   <div><span class="icon icon-skype"><i class="fab fa-skype"></i></span></div>
                   <div>
                     <h6>Skype</h6>
                     <a href="">l2topservers.com</a>
                   </div>
                 </div>
               </div>
             </div>
