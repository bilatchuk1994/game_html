  ...
  <div class="site-center">
    ...
    <main class="main">
      <div class="container">
        ...
        <div class="main-block rating-block">
          <div class="site-row">
            <div class="left-col">
              <h3>Lineage 2 Private Servers <span>Top 100</span></h3>
              <p>Welcome to the Lineage 2 Private Servers Top 100, the top sites list that is dedicated in showing you <br> the best Lineage 2 Private Servers gaming website links.</p>
            </div>
          </div>
          <div class="site-row">
            <div class="left-col">
