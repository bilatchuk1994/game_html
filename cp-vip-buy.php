            ...
            <div class="left-col">
              <div class="row">
                <div class="col-lg-12">
                 ...
                 <div><a data-tab="buy-vip" class="flex-center tab-link active" href=""><i class="fas fa-shopping-basket"></i> BUY VIP ADVERTISING</a></div>
                 <div><a data-tab="my-vip" class="flex-center tab-link" href=""><i class="fas fa-clipboard"></i> MY VIP ADVERTISING</a></div>
                 <div><a class="flex-center" href=""><i class="fas fa-cart-plus"></i> Get More Advertising</a></div>
               </div>
               <div class="view-block vip-buy">
               <div class="view-flex">
                 <div>
                   <h3>VIP advertising on L2topservers.com</h3>
                 </div>
                 <div>
               ...
               <div id="buy-vip" class="tab-block current">
                 <div class="row">
                 <div class="col-lg-6">
                  <div class="vip-buy-col">
                  <div class="vip-table-flex vip-top-red">
                        <div>
                      ...
                      <div class="row row-center">
                        <div class="col-7 col-lg-5 col-md-8">
                          <button>Buy this VIP</button>
                        </div>
                        <div class="col-5 col-lg-7 col-md-4">
                         <div class="vip-buy-text">
                            <h3>RED VIP <span>for</span> 10 day</h3>
               ...
               <table>
                 ...
                 <tr>
                   ...
                   <td>12931</td>
                   <td><a href="view-server.php"><i class="fas fa-search"></i></a></td>
