                      ...
                      <div>
                        <div class="cp-content get-code">
                           <div class="vote-flex">
                             ...
                             <div>
                               <div class="text-right">
                                 <p class="check"><span><i class="far fa-check-square"></i> Server is approved and listed!</span></p>
                                 <h4>Premium: <span> Active!</span></h4>
                                 <p>Start: 21.01.2019 18:12</p>
                                 <p>Ends on: 21.02.2019 18:12</p>
                               </div>
                             </div>
                           </div>
                           ...
                           <ul class="vote-btn-list">
                             ...
                             <li><a href="">Get Vote Code</a></li>
                             <li><a href="">Reward API</a></li>
                           ...
                           <ul class="vote-btn-list">
                             ...
                             <li><a href="">Classic Banners</a></li>
                           </ul>
