            ...
            <div class="left-col">
              <div class="row">
                <div class="col-lg-12">
                 ...
                 <div><a data-tab="buy-banner" class="flex-center tab-link active" href=""><i class="fas fa-shopping-basket"></i> Buy banners</a></div>
                 <div><a data-tab="edit-banner" class="flex-center tab-link" href=""><i class="fas fa-clipboard"></i> MY banners</a></div>
                 <div><a class="flex-center" href=""><i class="fas fa-cart-plus"></i> Get More Advertising</a></div>
               </div>
               <div class="buy-banners-block">
                 <div class="view-flex">
                 <div>
                   <h3>Background Right (400x1100)</h3>
                 </div>
                 <div>
               ...
               <div id="buy-banner" class="tab-block current">

               <div class="row">
                 <div class="col-lg-7 col-md-6">
                  <div class="attrach-bannerer">
                    Buy banners to attract more players.
                  </div>
                  <select id="banner-select" >
                      <option value="banner-left-block">400x1100 - Background Left - Expire: 15.11.2019 14:22</option>
                      <option value="banner-right-block">400x1100 - Background Left - Expire: 15.11.2019 14:22</option>
                      <option value="banner-top-left-block">400x1100 - Background Left - Expire: 15.11.2019 14:22</option>
                      <option value="banner-top-right-block">400x1100 - Background Left - Expire: 15.11.2019 14:22</option>
                      <option value="banner-side-top-block">400x1100 - Background Left - Expire: 15.11.2019 14:22</option>
                      <option value="banner-side-bottom-block">400x1100 - Background Left - Expire: 15.11.2019 14:22</option>
                    </select>
                    <select >
                      <option value="">7 Days - 56€</option>
                      <option value="">7 Days - 56€</option>
                    </select>
                    <input type="text" placeholder="Your website (https://website.com)">
                    <div class="uploads-img">
                     <span id="show-name">Upload image (max 350kb, .jpg, .gif, .png)</span>
                     <div class="choise-btn">
                       <input id="upload" type="file">
                     <span class="flex-center">Choose file</span>
                     </div>
                   </div>

                       <div class="form-message">
                        <div>
                          <button>BUY THIS BANNER</button>
                        </div>
                        <div>
                          <p>400x1100 - Background Left <span>for</span> 7 <span>days <br> Price:</span> 56€</p>
                        </div>
                      </div>
                 ...
                 <div class="col-lg-5 col-md-6">
                   <div class="buy-server-block">
                     <img src="img/buy-server.jpg" alt="">
                     <div class="flex-center banner-left-block active">Background Left</div>
                     <div class="flex-center banner-right-block">Background Right</div>
                     <div class="flex-center banner-top-left-block">Top Left</div>
                     <div class="flex-center banner-top-right-block">Top Right</div>
                     <div class="flex-center banner-side-top-block">Right Side 1</div>
                     <div class="flex-center banner-side-bottom-block">Right Side 2</div>
                   </div>
                 </div>
               </div>
               ...
               <div id="edit-banner" class="tab-block">
               ...
               <table>
                 ...
                 <tr>
                   <td>Server-name.ru  - <span>Big left banner (420x1080 px)</span></td>
                   <td>30 days 12 min 15 sec</td>
                   <td>12931</td>
                   <td><a href="cp-banners-edit.php"><i class="fas fa-pen"></i></a></td>
                   <td><a href=""><i class="fas fa-play"></i></a></td>
                 </tr>
                 <tr>
                   <td>Server-name.ru  - <span>Big left banner (420x1080 px)</span></td>
                   <td>0 days 0 min 0 sec</td>
                   <td>12931</td>
                   <td><a href="cp-banners-edit.php"><i class="fas fa-pen"></i></a></td>
                   <td><a href=""><i class="fas fa-stop"></i></a></td>
                 </tr>
                 <tr>
                   <td>Server-name.ru  - <span>Big left banner (420x1080 px)</span></td>
                   <td>30 days 12 min 15 sec</td>
