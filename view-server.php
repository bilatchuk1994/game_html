            ...
            <div class="left-col">
              <div class="row">
                <div class="col-lg-12">
                 ...
                 <div><a class="flex-center" href=""><i class="fas fa-shopping-basket"></i> BUY VIP ADVERTISING</a></div>
                 <div><a class="flex-center active" href=""><i class="fas fa-clipboard"></i> MY VIP ADVERTISING</a></div>
                 <div><a class="flex-center" href=""><i class="fas fa-cart-plus"></i> Get More Advertising</a></div>
               </div>
               <div class="view-block">
               <div class="view-flex">
                 <div>
                   <h3>Top Right Yellow VIP №4</h3>
                 </div>
                 <div>
               ...
               <div class="row">
                 ...
                 <div class="col-xs-6 col-lg-6">
                   <div class="view-server">
                     ...
                     <p>Your Advertising (Top Right Yellow VIP №4)</p>
                   </div>
                 </div>
               </div>
