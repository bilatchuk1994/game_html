                    ...
                    <div class="flex-cabiner">
                      <div>
                        <div class="cp-menu-back">
                          <div class="cp-menu">
                            <ul>
                              <li><a href=""><span><i class="fas fa-home"></i></span> My server</a></li>
                              ...
                              <li><a class="active" href=""><span><i class="fas fa-percent"></i></span> Promotions</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      <div>
                        <div class="cp-content cp-content-promotions">
                          <p><strong>200 евро</strong> за установку баннера</p>
                          <p><strong>1000 евро</strong> за установку голосовалки на сайт</p>
                       </div>
                     </div>
                   </div>
                 </div>
