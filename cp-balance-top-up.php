  ...
  <div class="site-center">
    ...
    <main class="main">
      <div class="container">
        ...
        <div class="main-block balance-block">
          <div class="site-row">
            <div class="left-col">
              <div class="row">
                <div class="col-lg-12">
                 ...
                 <div><a class="flex-center active" href=""><i class="fas fa-shopping-basket"></i> top up the balance</a></div>
                 <div><a class="flex-center" href=""><i class="fas fa-cart-plus"></i> Get More Advertising</a></div>
               </div>

                  <div class="view-flex">
                 <div>
                   <h3>TOP UP THE BALANCE</h3>
                 </div>
                 <div>
                 ...
                 <h5>Note. If you use unverified PayPal account, your server will be disabled.</h5>

                  <div class="top-up-balance">
                    <div class="row">
                    <div class="col-lg-6">
                      <div class="up-balance-input-flex">
                        <div>
                      ...
                      <div class="up-balance-input-flex">
                        ...
                        <div>
                          <input class="total-price" type="text" placeholder="95">
                        </div>
                      </div>
                      <div class="up-balance-input-flex">
                        <div>
                    ...
                    <label>I aggre (-on) with the terms & conditions</label>
                    </div>
                      <div class="balance-button">
                        <button>Buy COINS</button>
                      </div>
                      <p>If you have payment problems, any questions or special offers please <a href="">Contact us</a>.</p>
                    </div>
                    <div class="col-lg-6">
                      <div class="balance-table">
                      <div class="title-up-balance">
                        Discounts: 
                      </div>
                      <div class="up-balance-block">
                        <div class="up-balance-flex up-balance-flex-title">
                          <div>
                            <span>Dollar</span>
                          </div>
                          <div>
